"""OmniTFT - Main model class with novel regularization techniques.
"""
...
import data_formatter.base_formatter as base_formatter
...
# Default input types.
InputTypes = base_formatter.InputTypes
